...
import { Home, Flame, Star, User } from 'lucide-react'
...
export function MobileBottomNav({ session, subscriptionCount }: Props) {
  ...
  const items = [
    ...
    { href: '/forum/popular', icon: Flame, label: 'Populära', active: pathname === '/forum/popular' },
    { href: '/mina-forum',    icon: Star,  label: 'Mina',     active: pathname === '/mina-forum', badge: subscriptionCount > 0 ? subscriptionCount : undefined, authOnly: true },
